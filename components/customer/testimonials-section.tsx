  ...
  const testimonials = [
    {
      ...
      name: 'Priya Sundaram',
      location: 'Chennai, TN',
      comment: 'The Premium Royal Basmati Rice cooks so fluffy and aromatic! Perfectly aged grains that make my festive biryani special.',
      rating: 5,
    },
    {
      id: 't-2',
      ...
      location: 'Mumbai, MH',
      comment: 'Guntur Red Chilli Powder and Salem Turmeric have authentic stone-ground aroma. Pure color without any artificial additives!',
      rating: 5,
    },
    {
      id: 't-3',
      ...
      comment: 'The Multigrain Sathu Maavu & Sprouted Ragi Almond Mix are daily essentials for my kids. 100% natural, delicious, and energetic.',
      rating: 5,
    },
  ];
