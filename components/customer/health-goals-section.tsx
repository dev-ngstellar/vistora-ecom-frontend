...
export const HealthGoalsSection: React.FC = () => {
  ...
  const goals: Goal[] = [
    ...
    },
    {
      ...
      tagline: 'Ancient Hand-Pounded Rice, Karuppu Kavuni Black Rice and Mappillai Samba rich in antioxidants & iron.',
      icon: Activity,
      color: '#B45309',
      bgLight: '#FFFBEB',
    ...
    },
    {
      ...
      tagline: 'High-calcium native Ragi (Finger Millet), Kambu Kurunai & Horse Gram (Kollu) for natural vitality.',
      icon: Baby,
      color: '#A50025',
      bgLight: '#FFF0F3',
